...
//		System.out.println(vs.searchById(2));

		// vs.filterByCompanyNameStartswith('V').forEach(e->System.out.println(e));

		// vs.fetchByCompany("Vcompany2","Vcompany4").forEach(e->System.out.println(e));;

//		int rows = vs.update("DVaccine4", "Company4");
//		if (rows != 0) {
//			System.out.println(rows + " rows got updated");
//		} else {
//			System.out.println("No rows has been updated");
//		}
		
//		int rows = vs.delete("DVaccine4");
//		if (rows != 0) {
//			System.out.println(rows + " rows got deleted");
//		} else {
//			System.out.println("No rows has been deleted");
//		}
		
		int rows = vs.insert(1,"DVaccine4","Vcompany5");
		if (rows != 0) {
